...
function extend(SuperCon,SubCon){SubCon.prototype=new SuperCon();SubCon.prototype.super_=SuperCon.prototype;}
...
var dimensions=getDimensions(parsedData.width,parsedData.height,options.maxwidth,options.maxheight);parsedData.width=dimensions[0];parsedData.height=dimensions[1];return true;};Provider.prototype.onJson=function(data,anchor,options){var parsedData=this.parseData(data);if(this.validateData(parsedData,options)){this.render(parsedData,anchor,data);}
